...
void PositionOverlay::paint (Graphics& g)
{
	...
	if(duration > 0.0)
	{
		...
		g.drawLine(drawPosition, 0.0f, drawPosition, (float)getHeight(), 4.0f);
	}
...
void PositionOverlay::drawLoopOverlays(Graphics& g)
{
	...
	g.drawLine(loopStartDrawPos, 0.0f, loopStartDrawPos, (float)getHeight(), 4.0f);

	g.setColour(Colours::darkred);
	g.drawLine(loopEndDrawPos, 0.0f, loopEndDrawPos, (float)getHeight(), 4.0f);
}
